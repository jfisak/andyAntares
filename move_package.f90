...
IF(pack_index > SIZE(package)) THEN
 ...
 if(abs(dummypackage(cur_dummy_index)%pos(ind_x)) < smallNumber) dummypackage(cur_dummy_index)%pos(ind_x) = 0e0
 if(abs(dummypackage(cur_dummy_index)%pos(ind_y)) < smallNumber) dummypackage(cur_dummy_index)%pos(ind_y) = 0e0
 if(abs(dummypackage(cur_dummy_index)%pos(ind_z)) < smallNumber) dummypackage(cur_dummy_index)%pos(ind_z) = 0e0
ELSE
